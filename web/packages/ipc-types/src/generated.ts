...
export type ActionEntry = { id: string; title: string; icon?: string | null; command: string; mode: ActionMode; shortcut?: string | null }
...
export type Config = { schema_version: number; active_theme: string; 
/**
...
export type IpcError = { kind: "NotFound"; detail: { resource: string; id: string } } | { kind: "PermissionDenied"; detail: { reason: string } } | { kind: "PtySpawnFailed"; detail: { reason: string } } | 
/**
...
export type TaskDto = { id: number; name: string; cwd: string | null; status: TaskStatus; terminal_ids: number[]; 
/**
